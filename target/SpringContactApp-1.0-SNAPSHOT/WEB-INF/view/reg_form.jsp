...
<html>
    ...
    <body background="${url_bg}" class="bcground">
        <table class="nav_bar" width="80%" align="center">
            <tr >
                <td height="80px">
                    <%-- Header --%>
                ...
                <td height="350px" valign="top">
                    ...
                    <f:form action="${url_reg}" modelAttribute="command">
                        ...
                        <div class="form-group">
                            ...
                            <f:input type="phonenumber" class="form-control test" id="phoneInput" placeholder="Enter phone number" path="user.phone"/>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <f:input type="email" class="form-control test" id="emailInput" aria-describedby="emailHelp" placeholder="Enter email" path="user.email"/>
                        ...
                        <div class="form-group">
                            ...
                            <f:input type="password" class="form-control test" id="passwordInput" placeholder="Password" path="user.password"/>
                        </div>
